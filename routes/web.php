...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'namespace' => 'Admin', 'middleware' => 'admin'], function () {
    ...
    Route::get('purchase-order-lines', 'PurchaseOrderController@getPurchaseOrderLinesList')->name('purchase.order.lines');
    Route::get('purchase-order-lines/create', 'PurchaseOrderController@getPurchaseOrderLineCreate')->name('purchase.orderl.ines.create');
